            ...
            <div class="col-lg-10 ms-auto p-4 overflow-hidden">
                        ...
                        <form >
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" onclick="upd_general(site_title.value,site_about.value)" class="btn custom-bg text-white sahdow-none">Submit</button>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            Khách hàng không thể đặt phòng, khi trang shutdown được bật.
                        </p>
                    </div>
                </div>
...
<script>
    ...
    function upd_general(site_title_val, site_about_val) {
        ...
        xhr.onload = function() {
            ...
            if(this.responseText == 1) {
                ...
                alert('error','Lưu thất bại!'); // Thêm thông báo
                modal.hide();
            }
        }

        let data = 'site_title=' + encodeURIComponent(site_title_val) +
    ...
    function upd_shutdown(val)
    {
        ...
        xhr.onload = function() {
            if(this.responseText == 1) {
                if(val == 1) {
                    alert('success','Trang đã được đóng!');
                } else {
                    alert('success','Trang đã được mở!');
                }
                get_general();
            } else {
