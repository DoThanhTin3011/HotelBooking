...
<script>
    ...
    function add_facility() {
        ...
        data.append('desc', facility_s_form.elements['facility_desc'].value); // Sửa 'descs' thành 'desc'
        ...
        xhr.onload = function () {
            console.log(this.responseText); // Để debug
            var myModal = document.getElementById('facility-s');
            var modal = bootstrap.Modal.getInstance(myModal);
            modal.hide();

            if(this.responseText == 'inv_img'){
                alert('error','Chỉ cho file SVG được cho phép!');
            }
            else if (this.responseText == 'inv_size'){
                alert('error','Chỉ cho ảnh bé hơn 1MB!');
            }
            else if (this.responseText == 'upd_failed'){
                alert('error','Tải ảnh lên thất bại!');
            }
            else if (this.responseText == '1') { // Thêm điều kiện check response '1'
                alert('success', 'New facility added!');
                facility_s_form.reset();
                get_facilities(); // Thêm hàm này để refresh bảng
            }
            else {
                alert('error', 'Thêm facility thất bại! Error: ' + this.responseText);
            }
        }
        xhr.send(data);
    }
